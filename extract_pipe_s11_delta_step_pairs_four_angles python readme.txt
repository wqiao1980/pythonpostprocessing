Abaqus Pipe S11 Delta Four-Angle Fast Variant - User Instructions
==================================================================
...
- reads every frame but retains S11 only at -90, 0, 90, and 180 degrees;
...
disk speed, element count, and frame count. When --write-intermediate is not
used, this variant also skips the per-frame location sort.
...
abaqus python extract_pipe_s11_delta_step_pairs_four_angles.py --step-pair "AsLaid" "Operational"

Process all ODBs in another folder and write results elsewhere:

abaqus python "C:\python_aba\takeoutSFSM\extract_pipe_s11_delta_step_pairs_four_angles.py" --input-dir "C:\Data\BPTiberFL6" --output-dir "C:\Data\BPTiberFL6\02_Results" --step-pair "AsLaid" "Operational"

Process one ODB only:

abaqus python "C:\python_aba\takeoutSFSM\extract_pipe_s11_delta_step_pairs_four_angles.py" --input-dir "C:\Data\BPTiberFL6" --odb "model.odb" --output-dir "C:\Data\BPTiberFL6\02_Results" --step-pair "AsLaid" "Operational"
...
abaqus python extract_pipe_s11_delta_step_pairs_four_angles.py --step-pair "AsLaid" "Hydrotest" --step-pair "Hydrotest" "Operation"
...
abaqus python extract_pipe_s11_delta_step_pairs_four_angles.py --step-pair "AsLaid" "Operational" --write-intermediate

For each ODB and each requested pair, this writes a file whose name looks like:

model_Pair001_AsLaid_TO_Operational_S11_4ANGLES_INTERMEDIATE.rpt
